...
import org.dllwh.core.constant.SysLogConstant;
import org.dllwh.core.systemlog.SystemLogQueue;
...
public class WebLogAspect {
	 ...
	 */
	@Pointcut("execution(public * org.dllwh.controller.*.*(..))")
	public void webLog() {
	}

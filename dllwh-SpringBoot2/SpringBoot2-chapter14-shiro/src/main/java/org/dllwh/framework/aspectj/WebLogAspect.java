package org.dllwh.framework.aspectj;
...
import org.dllwh.framework.queue.SystemLogQueue;
...
public class WebLogAspect {
	 ...
	 */
	// @Pointcut("execution(public * org.dllwh.modules..*.*(..))")
	@Pointcut("execution(public * org.dllwh.modules..*.controller.*(..))")
	public void webLog() {
	}
